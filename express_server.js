...
//Could create a class here for URLs
const urlDatabase = {
  b2xVn2: {
...
app.get("/urls/:id", (req, res) => {
  ...
  const templateVars = { id: req.params.id, longURL: userURLs[req.params.id], user: users[req.session.user_id] || '' }; //pass unique visitors, lifetime visits, and all visits DT here for render
